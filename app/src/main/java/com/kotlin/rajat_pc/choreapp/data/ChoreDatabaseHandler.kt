...
import com.kotlin.rajat_pc.choreapp.model.*
import java.text.DateFormat
import java.util.*
import kotlin.collections.ArrayList

/**
 * Created by RAJAT-PC on 26-07-2017.
 */
    ...
    */
    ...
    fun readAChore(id: Int): Chore{
        ...
        var cursor: Cursor = db.query(TABLE_NAME, arrayOf(KEY_ID,
                            ...
                            KEY_CHORE_ASSIGNED_TO, KEY_CHORE_ASSIGNED_TIME),KEY_ID + "=?", arrayOf(id.toString()),
                            null, null, null, null)
       ...
       /* var dateFormat: java.text.DateFormat = DateFormat.getDateInstance()
        var formattedDate = dateFormat.format(Date(cursor.
                getLong(cursor.getColumnIndex(KEY_CHORE_ASSIGNED_TIME))).time) // July 26 2017*/
